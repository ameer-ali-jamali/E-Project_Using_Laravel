    ...
    <div class="container mt-0">
        ...
        <table class="table table-hover table-responsive mb-0">
            <div class="d-grid justify-content-end">
                ...
                <button class="btn btn-dark mb-3" data-toggle="modal" data-target="#registerNewUser"><i
                        class="fa-duotone fa-book"></i>Upload Book &nbsp;</button>
            </div>
            <tr>
                <th scope='col'>Id</th>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="container">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-outline">
                                        <label class="form-label font-family" for="issueDate">Book Issue Date :</label>
